...
/* brand mark — geometric "N" monogram with a forward-motion arrow accent */
function brandMark(size=30,{accent='#FFFFFF',ink='#151210'}={}){
  const sw = 3.2;
  return `<svg width="${size}" height="${size}" viewBox="0 0 32 32" fill="none">
    <path d="M8 24 V11.5" stroke="${ink}" stroke-width="${sw}" stroke-linecap="round"/>
    <path d="M8 11.5 L20 24" stroke="${ink}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M20 24 V15.5" stroke="${ink}" stroke-width="${sw}" stroke-linecap="round"/>
    <path d="M18.5 9 H24 V14.5" stroke="${accent}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M14 13.5 L24 9" stroke="${accent}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>`;
}
...
add('client/01-onboarding',430,932,3, phone(`
  <div style="flex:1;position:relative;display:flex;flex-direction:column;justify-content:flex-end;padding:0 30px 40px">
    ...
    <div style="position:absolute;top:70px;left:30px;display:flex;align-items:center;gap:12px">
      <div style="width:52px;height:52px;border-radius:15px;background:linear-gradient(135deg,#F7902E,#C0480A);display:flex;align-items:center;justify-content:center">${brandMark(32)}</div>
    ...
    <div style="position:absolute;top:44%;left:50%;transform:translate(-50%,-50%);width:280px;height:280px">
      <div style="width:100%;height:100%;border-radius:56px;background:linear-gradient(135deg,#D2560C,#F7902E);box-shadow:0 30px 60px rgba(234,91,12,.35);display:flex;align-items:center;justify-content:center">${brandMark(190)}</div>
    </div>
...
add('driver/00a-auth-phone',430,932,3, phone(`
  <div style="flex:1;display:flex;flex-direction:column;padding:8px 26px 34px">
    <div style="display:flex;align-items:center;gap:10px;margin-top:6px">
      <div style="width:40px;height:40px;border-radius:12px;background:linear-gradient(135deg,#F7902E,#C0480A);display:flex;align-items:center;justify-content:center">${brandMark(26)}</div>
...
add('control-panel/00-login',1440,900,2, desktop(`
  <div style="flex:1;display:flex">
    <div style="flex:1.1;background:linear-gradient(160deg,#0F0C09,#1C1712 55%,#C0480A);position:relative;display:flex;flex-direction:column;justify-content:space-between;padding:48px 52px;color:#fff">
      <div style="display:flex;align-items:center;gap:12px"><div style="width:46px;height:46px;border-radius:13px;background:linear-gradient(135deg,#F7902E,#C0480A);display:flex;align-items:center;justify-content:center">${brandMark(30)}</div><div style="font-weight:800;font-size:20px">NEXT <span style="color:${C.accent}">Freight</span></div></div>
...
add('fleet-portal/00-register',1440,900,2, desktop(`
  <div style="flex:1;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#0F0C09,#1C1712 60%,#C0480A)">
    <div style="width:640px;background:#fff;border-radius:24px;padding:36px 40px;box-shadow:0 40px 100px rgba(0,0,0,.4)">
      <div style="display:flex;align-items:center;gap:12px;margin-bottom:6px"><div style="width:44px;height:44px;border-radius:12px;background:linear-gradient(135deg,#F7902E,#C0480A);display:flex;align-items:center;justify-content:center">${brandMark(28)}</div><div style="font-weight:800;font-size:19px">NEXT <span style="color:${C.accent}">Freight</span></div></div>
...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .logo{width:34px;height:34px;border-radius:10px;background:linear-gradient(150deg,var(--p),var(--pd));display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800}
